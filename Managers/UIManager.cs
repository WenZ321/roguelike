...
public class UIManager : MonoBehaviour
{
    ...
    private void Start()
    {
        SetDungeonFloorText(MapManager.instance.SceneName);     //Sets dungeon floor as the one saved 
    ...
    public void SetDungeonFloorText(string name)
    {  //Dungeon Floor on bottom left 
        dungeonFloorText.text = name;
    }
