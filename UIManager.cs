...
public class UIManager : MonoBehaviour
{
    ...
    public void ToggleMenu()            //turns on or off the different menus
    {
        if (isMenuOpen)
        {
    ...
    {
        isMessageHistoryOpen = !isMessageHistoryOpen;          //If message history is on, we turn it off
        SetBooleans(messageHistory, isMessageHistoryOpen);     //This will either activate or inactivate the menu 
    }

    public void ToggleInventory(Actor actor = null)            //Same as above
    {
    ...
    public void ToggleDropMenu(Actor actor = null)             //Same as above
    {
    ...
    public void ToggleEscapeMenu()                             //Same as above
    {
