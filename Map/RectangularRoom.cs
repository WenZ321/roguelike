...
public class RectangularRoom
{
    ...
    public int X { get => x; set => x = value; }                      //X value of the bottom left corner
    public int Y { get => y; set => y = value; }                      //Y value of the bottom left corner
    public int Width { get => width; set => width = value; }          //Width of the room
    public int Height { get => height; set => height = value; }       //Height of the room
