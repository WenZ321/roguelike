...
public class SaveManager : MonoBehaviour
{
    ...
    [SerializeField] private string saveFileName = "saveThe.Wen";
    ...
    private void Awake()    //Same as the other manager's awake method
    {
    ...
    public void SaveGame(bool tempSave = true)              //Saves the game 
    {
...
[System.Serializable]
public class SaveData       //I'm assuming these two help save the user's data
{
